        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              {[
                {
                  title: "Work Order WO-2024-045 completed",
                  time: "2 hours ago",
                  status: "success",
                },
                {
                  title: "Purchase Order PO-2024-128 approved",
                  time: "4 hours ago",
                  status: "success",
                },
                {
                  title: "QC Test failed for Batch B-3344",
                  time: "5 hours ago",
                  status: "error",
                },
                {
                  title: "MRP Planning generated 8 shortages",
                  time: "1 day ago",
                  status: "warning",
                },
                {
                  title: "New Sales Order SO-2024-567 created",
                  time: "2 days ago",
                  status: "info",
                },
              ].map((activity, index) => (
        ...
        <CardContent>
          <div className="space-y-3">
            {[
              {
                batch: "B-3345",
                product: "White Enamel Paint",
                wo: "WO-2024-045",
                priority: "High",
              },
              {
                batch: "B-3346",
                product: "Blue Emulsion",
                wo: "WO-2024-046",
                priority: "Medium",
              },
              {
    ...
    <Card>
      ...
      <CardContent>
        <p className="text-gray-600">
          ...
          {currentUser.role}). Your dashboard will be customized based on your
